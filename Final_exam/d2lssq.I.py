...
import math
"""
USAMOS CHEBYSEHV PORQUE NOS AYUDA A TENER LA MEJOR APROXIMACIÓN Y NOS AYUDA
A MINIMIZAR EL ERROR CUADRÁTICO MEDIO, ASÍ COMO MINIMIZAR EL ERROR MÁXIMO QUE HAY EN 
CUALQUIER APROXIMACIÓN

NO HAY OTRO POLINOMIO ORTOGONAL QUE MINIMICE EL MÍNIMO Y EL MÁXIMO ERROR
QUE EXISTE EN CUALQUIER APROXIMACIÓN
"""
#
...
# GetFG es una función que me permite caluclar las dos matrices que hacen
# falta para obtener el aproximador en el intervalo orginal (ya no en el 
# intervalo de entre -1 a 1) y como una suma de monomios
def GetFG():
    F[1][1]=1
    F[1][2]=0
    F[2][2]=1
