...
for i in range(0,N+1):
    XY[i]=list(range(0,3))      # 2 columns (XY[N][1];XY[N][2])
#
...
for j in range(1,D+2):
    ...
    #endif
#endfor
print("Coeficientes del Polinomio de Chebyshev:")
...
#endTrydat
print("-----------------")
print("En el ARCHIVO DE RESULTADOS se pondrán los valores interpolados" )
OutDat=input("Dame el nombre del ARCHIVO DE RESULTADOS: \t")
try:
    FDO = open(OutDat,"w+")
except:
...
#        print("¡¡¡VALORES DE INTERPOLACIÓN FUERA DE RANGO!!!")
#        sys.exit("*** FIN DE PROGRAMA ***")
#    #endif
    ...
    for j in range(1,D+2):
        ys=ys+C[j]*T((j-1),xs)
    #endfor
    fila_i=("%12.6f \t %12.6f\r" % (x_i,ys))
    FDO.write(fila_i)
#endfor    
FDI.close()
FDO.close()
print("\n**** Los datos interpolados se escribieron en "+OutDat)
